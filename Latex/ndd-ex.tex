...
\begin{table}[H]
    \centering
        ...
        \begin{NiceTabular}{|l|l|l|}
            ...
            \hspace{0.5em}3\hspace{0.5em} & \multicolumn{1}{c}{\rule{0pt}{4ex}$\dfrac{1}{5}\left(y_3 - y_2 - 2y_1\right)$} \vspace{1ex} & \multicolumn{1}{c|}{$\sqrt{\dfrac{14}{25}}\,\sigma = 0.748\cdot\sigma$} \\ \hline

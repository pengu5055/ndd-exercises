...
%
\begin{equation}
    \bar{\Delta} = \Delta_p = \xi\left[\ln{\frac{2mc^2\beta^2\gamma^2}{I}} + \ln{\frac{\xi}{I} + j - \beta^2 - \delta(\beta\gamma)}\right]\>,
    \label{eq:landau}
\end{equation}
%
...
\end{equation}
%
for $x$ in $\rm{g/cm}^2$ and $K = 0.3\,\rm{MeV}\,\rm{cm}^2\rm{/g}$. \textbf{Warning:} $x$ here is normalized to $\rm{g/cm}^2$.
To know which distribution to use, we can use the following rule of thumb:
%
\begin{equation}

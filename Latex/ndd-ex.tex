...
%
\begin{equation}
    \left(\frac{\sigma_{p_t}}{p_t}\right)_\mathrm{MSC} = \frac{13.6\,\rm{MeV}}{eBL}\sqrt{\frac{d}{X_0}}\>,
    \label{eq:msc-semi}
\end{equation} 
%
...
%
\begin{equation}
    \left(\frac{\sigma_{p_t}}{p_t}\right)_\mathrm{MSC} = \frac{13.6\,\rm{MeV}}{eB\sqrt{X_0 L}}\>.
    \label{eq:msc-gas}
\end{equation}
%

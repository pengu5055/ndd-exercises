...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.65\textwidth]{../linearfit.pdf}
...
\begin{table}[H]
    \centering
        ...
        \begin{NiceTabular}{|l|l|l|}
            ...
            \hspace{0.5em}4\hspace{0.5em} & \multicolumn{1}{c}{\rule{0pt}{4ex}$\dfrac{1}{70}\left(30y_4 - y_3 - 18y_2 - 11y_1\right)$} \vspace{1ex} & \multicolumn{1}{c|}{$\dfrac{1}{\sqrt{5}}\,\sigma = 0.524\cdot\sigma$} \\ \hline
        \end{NiceTabular}

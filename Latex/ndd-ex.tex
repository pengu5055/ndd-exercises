...
%
\begin{align*}
    w_{\rm{Pb}} = \frac{1\cdot 207.2\>\rm{u}}{1\cdot + 207.2\>\rm{u} + 2\cdot 19\>\rm{u}} = 0.866 \>, \\
    w_{\rm{F}} = \frac{2\cdot 19\>\rm{u}}{1\cdot + 207.2\>\rm{u} + 2\cdot 19\>\rm{u}} = 0.134 \>,
\end{align*}
%
...
%
\begin{flalign}
    -\left\langle \frac{\dd E}{\dd x} \right\rangle _{\rm{Pb}}
\end{flalign}
% Add references
% \newpage
